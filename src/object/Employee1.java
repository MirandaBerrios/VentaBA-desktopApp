...
public class Employee1 {
    ...
    public Employee1(String id, String name, String lastName, String rut, String adress, String emai, String password, String repeatPassword, String isAuthenticate, String isOnline, String idRole) {
        this.id = id;
        this.name = name;
        this.lastName = lastName;
        this.rut = rut;
