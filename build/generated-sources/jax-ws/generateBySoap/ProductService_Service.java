 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://Service/", wsdlLocation = "http://localhost:8080/WebSoapBA/ProductService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://Service/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebSoapBA/ProductService?wsdl");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://Service/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service/", "ProductServicePort"), ProductService.class, features);
    }
